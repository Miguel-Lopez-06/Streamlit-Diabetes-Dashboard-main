...
# Prediction Page
    ...
    with col_pred[1]:
        ...
        log_Glucose = st.number_input('Glucose', min_value=0, max_value=100, step=1, key='log_Glucose', value=0 if st.session_state.clear else st.session_state.get('log_Glucose', 0.0))
