...
# Prediction Page
    ...
    with col_pred[1]:
        ...
        log_Insulin = st.number_input('Insulin', min_value=0, max_value=1000, step=1, key='log_Insulin', value=0 if st.session_state.clear else st.session_state.get('log_Insulin', 0))
