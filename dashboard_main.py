...
# Prediction Page
    ...
    with col_pred[1]:
        ...
        log_DiabetesPedigreeFunction = st.number_input('DiabetesPedigreeFunction', min_value=0.000, max_value=0.500, step=0.010, key='log_DiabetesPedigreeFunction', value=0.000 if st.session_state.clear else st.session_state.get('log_DiabetesPedigreeFunction', 0.0))
